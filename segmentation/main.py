...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='pt', help='pt for PointGPT and pt_mae for PointMAE')
    parser.add_argument('--model_name', type=str, default='PointGPT_S', choices=['PointGPT_S', 'PointGPT_B', 'PointGPT_L','Point_MAE'])
